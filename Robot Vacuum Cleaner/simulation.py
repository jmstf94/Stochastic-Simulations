...
# If you get a "Bad magic number" ImportError, you are not using Python 3.8, change the last
# number os ps2_verify_movement38 accordingly, it works for versions 3.5 to 3.10
